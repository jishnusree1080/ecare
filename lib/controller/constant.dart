...
Color themeBlue = const Color(0xFF7390f0);
LinearGradient themeGradient = const LinearGradient(colors: [Color(0xFFb8d3ff),Color(0xFFFDFCFB)]);
...
const kAnimationDuration = Duration(milliseconds: 50);
